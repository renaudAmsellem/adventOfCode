...
const visitedSpaces: VisitedSpaces = [];
...
console.log(maxLengthHorizontal);
console.log(maxLengthVertical);
...
console.log(visitedSpaces);
console.log(visitedSpaces.length);
